...
exports.init = function (cli) {
  ...
  vm.command('export <vm-name> <file-path>')
	...
	docker.command('extension <dns-name>')
      .usage('[options] <dns-name>')
      .description($('Get docker VM extension'))
      .execute(function (dnsName, options, callback) {
        var vmClient = new VMClient(cli, options.subscription);
        vmClient.getDockerVMExtension(dnsName, options, callback, logger);
    });
